...
/** An entity which can be dumped as a vcard.
 *
...
public class VcardEntity<T> {
   ...
   */
  @NoWrap
  public void dump(final XmlEmit xml, final DumpType dtype) throws CalFacadeException {
  ...
  public void dump(final XmlEmit xml, final DumpType dtype,
    ...
    /* The NoDump annotation applied to a class indicates for a null value, skip
     * the entire class otherwise the value is a list of fields to skip.
     */
  ...
  private boolean dumpValue(final XmlEmit xml, final Method m, final Dump d,
     ...
     */
    if (methVal instanceof VcardEntity) {
      VcardEntity de = (VcardEntity)methVal;
    ...
    if (methVal instanceof Collection) {
      ...
      for (Object o: c) {
        if ((o instanceof VcardEntity) &&
            (!((VcardEntity)o).hasDumpValue())) {
          continue;
        }
