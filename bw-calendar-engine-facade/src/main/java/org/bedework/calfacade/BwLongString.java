...
public class BwLongString extends BwStringBase {
   ...
   */
  public BwLongString(final String lang,
                      final String value) {
    super(lang, value);
  }
   ...
   */
  public static BwLongString findLang(final String lang, final Collection<BwLongString> c) {
    return (BwLongString)BwStringBase.findLanguage(lang, c);
  }
  ...
  @Override
  public Object clone() {
    return new BwLongString(getLang(),
                            getValue());
  }
}
