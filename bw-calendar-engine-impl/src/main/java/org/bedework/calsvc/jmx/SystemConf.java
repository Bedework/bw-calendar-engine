...
public class SystemConf extends ConfBase<SystemPropertiesImpl>
  ...
  private static final String datauriPname = "org.bedework.caldav.datauri";
  ...
  public void setPublicCalendarRoot(final String val) {
    getConfig().setPublicCalendarRoot(val);
  }
  ...
  public void setUserCalendarRoot(final String val) {
    getConfig().setUserCalendarRoot(val);
  }
  ...
  public void setUserDefaultCalendar(final String val) {
    getConfig().setUserDefaultCalendar(val);
  }
  ...
  public void setDefaultNotificationsName(final String val) {
    getConfig().setDefaultNotificationsName(val);
  }
  ...
  public void setDefaultReferencesName(final String val) {
    getConfig().setDefaultReferencesName(val);
  }
  ...
  public void setGlobalResourcesPath(final String val) {
    getConfig().setGlobalResourcesPath(val);
  }
