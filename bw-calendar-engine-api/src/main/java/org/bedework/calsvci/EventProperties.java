...
public interface EventProperties <T extends BwEventProperty> extends Serializable {
   ...
   */
  public Collection<T> get(String ownerHref,
   ...
   * @throws CalFacadeException
   */
  public T getCached(String uid) throws CalFacadeException;
   ...
   * @throws CalFacadeException
   */
  public Collection<T> getCached(Collection<String> uids) throws CalFacadeException;
